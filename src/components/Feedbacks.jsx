    ...
    <div className="mt-1">
      ...
      <div className="mt-7 flex justify-between items-center gap-1">
        <div className="flex flex-1 flex-col">
          ...
          <p className="mt-1 text-secondary text-[14px]">{designation} at {company}</p>
        </div>
...
const Feedbacks = () => {
  return (
    <div className="mt-12 bg-yellow-400 rounded-[20px]">
      ...
      <div className={`${styles.padding} -mt-20 pb-14 flex flex-wrap gap-5`}>
